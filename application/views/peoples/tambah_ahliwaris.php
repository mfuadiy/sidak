<form action="<?= base_url(); ?>peoples/insert_ahliwaris" method="post" enctype="multipart/form-data">
<div class="container">
    <div class="row mt-3">
      <div class="col-md-10">
  ...
  <div class="form-group">
    <label>NPK</label>
    <input type="text" class="form-control" id="noreg" name="noreg" value="<?= $alldata['noreg']; ?>" readonly>
  </div>

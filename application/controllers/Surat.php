...
class Surat extends CI_Controller
{
    ...
    public function suratmasuk()
    {
        ...
        $data['allSurat']    = $this->Datul_model->getAllSurat($config['per_page'], $data['start'], $data['keyword']);
        //$data['allSurat'] = $this->db->get('surat_masuk')->result_array();
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Surat Masuk Berhasil Di Tambahkan!</div>');
    ...
    public function updatesurat()
    {
        ...
        $this->db->set('tujuan', $a1 . ' ' . $a2 . ' ' . $a3 . ' ' . $a4 . ' ' . $a5,);
    ...
    public function excel5()
    {
        ...
        $allSurat = $this->Datul_model->getSurat();
        ...
        $writer->openToBrowser('Contoh-Data-Saja.xls');
